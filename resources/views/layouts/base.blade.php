        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-header">TEACHERS ACTIVITIES</li>
                    <li class="nav-item">
                        <a href="{{route('schoollogbook.index')}}" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="{{route('schoolscheme.index')}}" class="nav-link">
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Scheme Of Works
                            </p>
                    ...
                    <li class="nav-item">
                        <a href="{{route('lesson_development.index')}}" class="nav-link">
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Lesson Plan
                    ...
                    <li class="nav-item">
                        <a href="{{route('darasa.index')}}" class="nav-link">
