...
@section('content')
    ...
    <div class="card card-warning">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form action="{{route('journal.update', $journal->slug)}}" method="post">
                @csrf
                @method('PUT')
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="school_journal_id" name="school_journal_id" >
                            <option value="{{$journal->school_journal_id}}">{{$journal->school_journal->journal_name}}</option>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="subject_id" name="subject_id" >
                            <option value="{{$journal->subject_id}}">{{$journal->subject->subject_name}}</option>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="session" name="session" >
                            <option value="{{$journal->session}}">{{$journal->session}}</option>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="concept_covered" class="form-control @error('concept_covered') is-invalid @enderror" rows="3" value="" name="concept_covered" placeholder="Enter ...">{{ $journal->concept_covered}}</textarea>
                    </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="teachers_comment" class="form-control @error('teachers_comment') is-invalid @enderror" rows="3" value="" name="teachers_comment" placeholder="Enter ...">{{ $journal->teachers_comment}}</textarea>
                    </div>
