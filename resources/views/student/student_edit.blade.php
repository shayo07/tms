        ...
        <div class="card-body">
            <form action="{{route('students.update', $student->slug)}}" method="post">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input id="firstname" type="text"  class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ $student->firstname}}" >
                            @error('firstname')
                ...
                <div class="form-group">
                    ...
                    <input id="parent_emailaddress" type="text"  class="form-control @error('parent_emailaddress') is-invalid @enderror" name="parent_emailaddress" value="{{ $student->parent_emailaddress}}" >
                ...
                <div class="form-group">
                    ...
                    <input id="home_address" type="text"  class="form-control @error('home_address') is-invalid @enderror" name="home_address" value="{{ $student->home_address}}" >
                    @error('home_address')
                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="age" type="text"  class="form-control @error('age') is-invalid @enderror" name="age" value="{{ $student->age}}" >
                            @error('age')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
